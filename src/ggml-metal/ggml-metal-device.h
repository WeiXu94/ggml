...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_custom_erf          (ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_custom_reduce_rows  (ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_custom_msdeform_attn(ggml_metal_library_t lib, const struct ggml_tensor * op);
